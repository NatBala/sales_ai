...
export default function PrepMe() {
  ...
  const mayaLeadIdRef = useRef(sessionStorage.getItem("maya_prep_lead"));
  if (mayaLeadIdRef.current) sessionStorage.removeItem("maya_prep_lead");
  ...
  // Auto-select and generate brief when Maya navigates here
  useEffect(() => {
