    ...
    createMeeting({
      ...
      onSuccess: () => {
        setBookingConfirmed({
          ...
          agendaTopic: emailSubject || "Capital Group working session",
        });
      },
    });
  };
                ...
                <div className="rounded-3xl border border-white/8 bg-gradient-to-br from-[#0a1628] via-[#0d1f3c] to-[#071224] p-10 flex flex-col items-center justify-center gap-6 text-center" style={{ minHeight: 380 }}>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground max-w-xs">
                      AI will write a 3-paragraph email personalized with {lead.name}'s AUM, alpha opportunity, and Capital Group talking points.
                    </p>
                  </div>
                  <motion.button
              ...
              <div className="relative flex flex-col items-center justify-center p-10 gap-8">
                ...
                <div className="relative flex flex-col items-center gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-teal-400/80 text-sm">Capital Group Digital Desk</p>
                  </div>
                </div>
                    ...
                    {callStatus === "active" ? (
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground/40 text-center max-w-[240px]">
                          Maya will identify a pain point, match it to a Capital Group module, and close a calendar slot.
                        </p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                ...
                {callStatus === "idle" && (
                  ...
                  >
                    {[
                      ...
                      { step: "2", label: "Matches module", desc: "Connects to Capital Group value prop" },
            ...
            {callStatus === "idle" && (
              ...
              >
                ...
                {[
                  ...
                  "One proof point from the Capital Group corpus",
