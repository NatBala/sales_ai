...
export default function FollowMe() {
  ...
  const {
    ...
    onUserTranscript: (transcript) => {
      ...
      void (async () => {
        try {
          const res = await fetch("/api/agents/follow-me/normalize-transcript", {
            method: "POST",
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(async () => {
      ...
      try {
        const res = await fetch("/api/agents/follow-me/live", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch("/api/agents/follow-me", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
