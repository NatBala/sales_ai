...
const EMAIL_ME_URL = "https://gentle-moss-0d4d5121e.6.azurestaticapps.net/";
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Embedded My Email workspace from the deployed Azure application.</p>
            </div>
          </div>
