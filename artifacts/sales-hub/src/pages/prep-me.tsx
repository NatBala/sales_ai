...
const PREP_ARTICLE_CATALOG: ArticleCatalogEntry[] = [
  {
    title: "Fixed income remains key to long-term diversification",
    url: "https://investor.vanguard.com/investor-resources-education/article/fixed-income-remains-key-to-long-term-diversification",
    topic: "Active fixed income",
  },
  {
    title: "Vanguard launches new short duration bond ETF",
    url: "https://investor.vanguard.com/investor-resources-education/news/vanguard-launches-new-short-duration-bond-etf",
    topic: "Active fixed income",
  },
  {
    title: "Index funds vs. actively managed funds",
    url: "https://investor.vanguard.com/investor-resources-education/understanding-investment-types/index-funds-vs-actively-managed-funds",
    topic: "Active fixed income",
  },
  {
    title: "What higher rates for longer could mean for bondholders",
  ...
  {
    title: "How bonds can strengthen your portfolio",
    url: "https://investor.vanguard.com/investor-resources-education/article/how-bonds-can-strengthen-portfolio",
    topic: "Active fixed income",
  },
  {
    title: "AI exuberance: Economic upside, stock market downside",
    url: "https://investor.vanguard.com/investor-resources-education/article/ai-exuberance-economic-upside-stock-market-downside",
    topic: "Market outlook",
  },
  {
    title: "Beyond the landing: Our economic outlook for 2025",
    url: "https://investor.vanguard.com/investor-resources-education/article/beyond-landing-our-economic-outlook-2025",
    topic: "Market outlook",
  },
  {
    title: "Amid turbulence, a new economic outlook",
    url: "https://investor.vanguard.com/investor-resources-education/article/amid-turbulence-a-new-economic-outlook",
    topic: "Market outlook",
  },
  {
    title: "Looking toward the future during periods of volatility",
    url: "https://investor.vanguard.com/investor-resources-education/article/looking-toward-the-future-during-periods-of-volatility",
    topic: "Market outlook",
  },
  {
    title: "A new day for Federal Reserve policy",
    url: "https://investor.vanguard.com/investor-resources-education/article/a-new-day-for-federal-reserve-policy",
    topic: "Market outlook",
  },
  {
    title: "Rebalancing your portfolio",
    url: "https://investor.vanguard.com/investor-resources-education/portfolio-management/rebalancing-your-portfolio",
    topic: "Portfolio management",
  },
  {
    title: "Diversifying your portfolio",
    url: "https://investor.vanguard.com/investor-resources-education/portfolio-management/diversifying-your-portfolio",
    topic: "Portfolio management",
  },
  {
    title: "Asset location can lead to lower taxes",
    url: "https://investor.vanguard.com/investor-resources-education/article/asset-location-can-lead-to-lower-taxes",
    topic: "Portfolio management",
  },
  {
    title: "How to choose a financial advisor",
    url: "https://investor.vanguard.com/investor-resources-education/article/how-to-choose-a-financial-advisor",
    topic: "Portfolio management",
  },
  {
    title: "Account consolidation: Streamline your finances",
    url: "https://investor.vanguard.com/investor-resources-education/article/account-consolidation",
    topic: "Portfolio management",
  },
];

const PREP_COMPETITOR_COMPARISON_PAIRS = [
  { vanguardFund: "VOO", competitorFund: "IVV", label: "IVV vs VOO" },
  { vanguardFund: "VOO", competitorFund: "SPYM", label: "SPYM vs VOO" },
  { vanguardFund: "VTI", competitorFund: "ITOT", label: "ITOT vs VTI" },
  { vanguardFund: "VTI", competitorFund: "SCHB", label: "SCHB vs VTI" },
  { vanguardFund: "VEA", competitorFund: "IEFA", label: "IEFA vs VEA" },
  { vanguardFund: "VEA", competitorFund: "SCHF", label: "SCHF vs VEA" },
  { vanguardFund: "VUG", competitorFund: "IWF", label: "IWF vs VUG" },
  { vanguardFund: "VUG", competitorFund: "SCHG", label: "SCHG vs VUG" },
  { vanguardFund: "VTV", competitorFund: "IWD", label: "IWD vs VTV" },
  { vanguardFund: "VTV", competitorFund: "SCHV", label: "SCHV vs VTV" },
] as const;
  ...
  const topOpportunity =
    (advisorData?.etfOpportunities ?? 0) >= (advisorData?.fiOpportunities ?? 0)
      ? {
          ...
          detail: `Review ETF opportunity of ${formatCompactMoney(advisorData?.etfOpportunities)} and where Vanguard should lead.`,
        }
      : {
          title: "Fixed Income Opportunity Review",
          detail: `Review fixed income opportunity of ${formatCompactMoney(advisorData?.fiOpportunities)} and where Vanguard should lead.`,
        };
...
export default function PrepMe() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        const response = await fetch(`/api/leads/${selectedMeeting.leadId}`);
        if (!response.ok) {
              ...
              <Card className="border border-indigo-500/20 bg-indigo-500/5">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    ...
                    <div className="rounded-xl border border-white/10 bg-white/5 p-3 text-white/80">
                      Use follow-ups like "What is the key sales note?" or "How should I position Vanguard?"
                    </div>
                  </div>
                  ...
                  <CardContent className="p-6">
                    <div className="grid gap-4 md:grid-cols-3">
                      ...
                      <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-white/80">
                          "What is the most important sales note?" "How should I position Vanguard?" "What competitors are already in the book?"
                        </p>
                      </div>
                      <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
